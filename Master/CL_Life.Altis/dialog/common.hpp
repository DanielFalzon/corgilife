...
class CL_RscControlsGroup {
	...
	class VScrollBar : CL_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};

	class HScrollBar : CL_RscScrollBar
	{
		height = 0.028;
	};
...
class CL_RscControlsGroupNoScrollbars : CL_RscControlsGroup {
...
class CL_RscListNbox {
	...
	autoScrollDelay = 5;
	autoScrollRewind = 0;
	class ListScrollBar: CL_RscScrollBar{};
	class ScrollBar: CL_RscScrollBar{};
};
...
class CL_RscTextMulti: CL_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class CL_RscPictureKeepAspect : CL_RscPicture
{
	style = 0x30 + 0x800;
};

class CL_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class CL_RscButtonTextOnly : CL_RscButton {
	SizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class CL_RscButtonMenu : CL_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class CL_RscButtonInvisible : CL_RscButtonMenu {
...
class CL_RscShortcutButtonMain : CL_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class CL_RscBackground: CL_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class CL_RscCombo {
	...
	class ComboScrollBar : CL_RscScrollBar {};
};
