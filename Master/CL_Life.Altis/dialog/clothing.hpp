class CL_Clothing {
	...
	class controls {
		...
		class ClothingList: CL_RscListBox {
			idc = 3101;
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[_this] call CL_fnc_changeClothes;";
		...
		class PriceTag: CL_RscStructuredText {
			idc = 3102;
			text = "";
			sizeEx = 0.035;
		...
		class TotalPrice: CL_RscStructuredText {
			idc = 3106;
			text = "";
			sizeEx = 0.035;
		...
		class FilterList: CL_RscCombo {
			idc = 3105;
			colorBackground[] = {0,0,0,0.7};
			onLBSelChanged  = "_this call CL_fnc_clothingFilter";
			x = 0.0822359 * safezoneW + safezoneX;
		...
		class CloseButtonKey: CL_RscButtonMenu {
			...
			onButtonClick = "closeDialog 0; [] call CL_fnc_playerSkins;";
		...
		class BuyButtonKey: CL_RscButtonMenu {
			idc = -1;
			text = "$STR_Global_Buy";
			onButtonClick = "[] call CL_fnc_buyClothes;";
			x = 0.0822359 * safezoneW + safezoneX;
			y = 0.489992 * safezoneH + safezoneY;
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class viewAngle: CL_RscXSliderH {
			color[] = {1, 1, 1, 0.45};
			colorActive[] = {1, 1, 1, 0.65};
			idc = 3107;
			text = "";
			onSliderPosChanged = "[4,_this select 1] call CL_fnc_s_onSliderChange;";
			tooltip = "";
