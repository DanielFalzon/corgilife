class CL_news_broadcast {
	idd = 100100;
	name= "CL_news_broadcast";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class MsgHeaderEdit: CL_RscEdit {
			idc = 100101;
			text = "";
			sizeEx = 0.035;
			x = 0.11;
		...
		class MsgContentEdit: CL_RscEdit {
			idc = 100102;
			text = "";
			sizeEx = 0.035;
			x = 0.11;
		...
		class MessageInfo: CL_RscStructuredText {
			colorBackground[] = {0, 0, 0, 0};
			idc = 100103;
			text = "";
			x = 0.1;
		...
		class ConfirmButtonKey: CL_RscButtonMenu {
			idc = 100104;
