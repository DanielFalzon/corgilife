class CL_ticket_give {
	...
	class controls {
		...
		class payTicket: CL_RscButtonMenu {
			idc = -1;
			text = "$STR_Ticket_GiveTicket";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call CL_fnc_ticketGive";
			x = 0.45;
			y = 0.35;
			w = (6.25 / 40);
			h = (1 / 25);
...
class CL_ticket_pay {
	...
	class controls {
		...
		class payTicket: CL_RscButtonMenu {
			...
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call CL_fnc_ticketPay;";
		...
		class refuseTicket: CL_RscButtonMenu {
			idc = -1;
