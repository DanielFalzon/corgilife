...
[format ["%1 (%2) Teleported %3 (%4) to position: %5.",profileName,getPlayerUID player,_target getVariable ["realname",name _target],getPlayerUID _target,getPos player],"AdminLog"] remoteExecCall ["A3Log",2];
