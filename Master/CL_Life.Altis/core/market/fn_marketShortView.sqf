...
{
	if (_x in CL_market_shortnames) then {
		_didanything = true;

		_row = [_x] call CL_fnc_marketGetPriceRow;
		...
		_text = format ["%1<br/><t size='1.2'>%2</t><br/><t size='1.3' color='#FFFF00'>%3 $</t><br/>", _text,_resname, [_price] call CL_fnc_numberText];
