...
if (_value > 0) then {
	[0,"STR_NOTF_VehContraband",true,[[_value] call CL_fnc_numberText]] remoteExecCall ["CL_fnc_broadcast",RCLIENT];
...
[format ["%1 (%2) searched a vehicle and found $%3 worth of contraband.",profileName,getPlayerUID player,_value],"PoliceLog"] remoteExecCall ["A3Log",2];
