...
{
	if (!isNull _x && alive _x && player distance _x < 4 && !(_x isEqualTo player)) then {
...
_mstatus ctrlSetStructuredText parseText format["<img size='1.3' image='icons\ico_bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='icons\ico_money.paa'/> <t size='0.8'>$%2</t>",[CL_bmoola] call CL_fnc_numberText,[CL_cmoola] call CL_fnc_numberText];
ctrlSetText[2009,format["Weight: %1 / %2", CL_carryWeight, CL_maxWeight]];
