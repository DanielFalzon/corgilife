	...
	} else {
{
	...
	if (_type isEqualTo 0) then {
		...
		_itemName = ([_item] call CL_fnc_fetchCfgDetails) select 1;
		_pic = [_item] call CL_fnc_fetchCfgDetails select 2;
		};
	};
	...
	_myListbox lbAdd format ["%5 lots of %3 for $%2 by %1, expires in %4 hours",_sellerName,[_price] call CL_fnc_numberText,_itemName,[_time] call CL_fnc_numberText,[_amount] call CL_fnc_numberText];
