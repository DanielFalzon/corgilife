...
*/
private _ret = 0; // Set number to 0 
private _RandomNumber = floor(random 1000000); // Generator Massive Random Number;
private _VirtReel = _RandomNumber mod 64; // Remainder of the division x / 64
...
switch _VirtReel do {
	...
	case 45;
	case 46;
	case 47: { _ret = 4;}; // 1 in 4 chance
	case 48;
	case 49;
	case 50;
	case 51;
	case 52;
	case 53: { _ret = 5;}; // 1 in 4 chance
	case 54;
	case 55;
	case 56;
	case 57: { _ret = 6;}; // 1 in 4 chance
	case 58;
	case 59;
