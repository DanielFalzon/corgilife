...
_return = [];
_savedVirtualItems = CL_Settings(getArray,"saved_virtualItems");
...
if (playerSide isEqualTo west || playerSide isEqualTo civilian && {CL_Settings(getNumber,"save_civilian_weapons") isEqualTo 1}) then {
...
if (CL_Settings(getNumber,"save_virtualItems") isEqualTo 1) then {
