...
*/
	...
	class polymer {
		MaterialsReq[] = {{"oil_unprocessed",20}};
		MaterialsGive[] = {{"polymer",1}};
		Text = "STR_Craft_Polymer";
		//ScrollText = "Process Oil";
		NoLicenseCost = -1;
	};
	
	class firingPin {
		MaterialsReq[] = {{"iron",30}};
		MaterialsGive[] = {{"firing_pin",1}};
		Text = "STR_Craft_FiringPin";
		//ScrollText = "Process Oil";
		NoLicenseCost = -1;
	};
	
	class pipe {
		MaterialsReq[] = {{"copper_refined",30}};
	...
	class aluminium {
		MaterialsReq[] = {{"aluminium_unrefined",1}};
		MaterialsGive[] = {{"aluminium_refined",1}};
		Text = "STR_Refine_Aluminium";
		//ScrollText = "Refine Aluminium";
		NoLicenseCost = 100000;
	};
