...
#define ITEM_VARNAME(varName) format ["CL_inv_%1",M_CONFIG(getText,"VirtualItems",varName,"variable")]
...
//UI Macros
#define CLdisplay (uiNamespace getVariable ["playerHUD",displayNull])
#define CLctrl(ctrl) ((uiNamespace getVariable ["playerHUD",displayNull]) displayCtrl ctrl)
