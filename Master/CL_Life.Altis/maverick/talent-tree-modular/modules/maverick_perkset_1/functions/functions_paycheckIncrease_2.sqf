...
_ownsDependency1 = [CL_currentExpPerks, "perk_paycheck_3"] call mav_ttm_fnc_hasPerk;
_ownsDependency2 = [CL_currentExpPerks, "perk_paycheck_4"] call mav_ttm_fnc_hasPerk;
