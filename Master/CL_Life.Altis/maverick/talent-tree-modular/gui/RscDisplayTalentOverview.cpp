class TTM_GUI_RscDisplayTalentOverview {
    ...
    class controls {
		...
		class textCurrentRank: CL_RscStructuredText
		{
			idc = 3;
			text = ""; //--- ToDo: Localize;
			x = 0.298906 * safezoneW + safezoneX;
		...
		class textStatusInfo: CL_RscText
		{
			idc = 5;
			text = ""; //--- ToDo: Localize;
			x = 0.343156 * safezoneW + safezoneX;
		...
		class progressRankProgress: CL_RscProgress
		{
			idc = 6;
			x = 0.340156 * safezoneW + safezoneX;
			y = 0.291 * safezoneH + safezoneY;
		...
		class textPerkSubtitle: CL_RscText
		{
			idc = 9;
		...
		class textPerkDescription: CL_RscStructuredText
		{
			idc = 11;
			x = 0.494844 * safezoneW + safezoneX;
		...
		class RscButton_1600: CL_RscButtonMenu
		{
			idc = 10;
