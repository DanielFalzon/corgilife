...
[] spawn {
	...
	CL_perksInitialized = false;
	CL_currentExpPerks = (0 call mav_ttm_fnc_generateBasePerks);
	CL_currentExpLevel = 0;
	CL_currentExp = 0;
	CL_currentPerkPoints = 0;
