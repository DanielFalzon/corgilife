...
((findDisplay 5200) displayCtrl 3) ctrlAddEventHandler ["ButtonClick",{
	...
	closeDialog 0;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Underglow successfully added, press SHIFT-L to activate<br/><t color='#12FE00'>$%1</t> left</t>",[CL_cmoola] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
...
((findDisplay 5200) displayCtrl 4) ctrlAddEventHandler ["ButtonClick",{
	...
	// Refund money
	CL_cmoola = CL_cmoola + mav_tuning_rgbprice;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'><t color='#12FE00'>$%1</t> have been refunded to your account<br/><t color='#12FE00'>$%2</t> left</t>",[mav_tuning_rgbprice] call BIS_fnc_numberText,[CL_cmoola] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
