...
class mav_tuning_dialog_main {
    ...
    duration = 999999;
    class controls {
		class CL_RscText_1000: CL_RscText
		{
			idc = -1;
		...
		class CL_RscText_1001: CL_RscText
		{
			idc = -1;
		...
		class CL_RscText_1002: CL_RscText
		{
			idc = -1;
			x = 0.0359375 * safezoneW + safezoneX;
		...
		class CL_RscListbox_1500: CL_RscListbox
		{
			idc = 0;
			x = 0.0410937 * safezoneW + safezoneX;
		...
		class CL_RscButtonMenu_2400: CL_RscButtonMenu
		{
			idc = 1;
...
class mav_tuning_dialog_rgbcolor {
    ...
    class controls {
		...
		class CL_RscSlider_1900: CL_RscSlider
		{
			idc = 0;
		...
		class CL_RscSlider_1901: CL_RscSlider
		{
			idc = 1;
			x = 0.082344 * safezoneW + safezoneX;
			y = 0.434 * safezoneH + safezoneY;
		...
		class CL_RscSlider_1902: CL_RscSlider
		{
			idc = 2;
			x = 0.082344 * safezoneW + safezoneX;
		...
		class CL_RscText_1003: CL_RscText
		{
			idc = -1;
		...
		class CL_RscButtonMenu_2401: CL_RscButtonMenu
		{
			idc = 4;
