...
if (count _units isEqualTo 0) exitWith {[_list] remoteExec ["CL_fnc_wantedList",_ret];};
...
if (count _list isEqualTo 0) exitWith {[_list] remoteExec ["CL_fnc_wantedList",_ret];};

[_list] remoteExec ["CL_fnc_wantedList",_ret];
