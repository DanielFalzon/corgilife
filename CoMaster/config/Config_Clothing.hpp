...
*/
	class bruce {
		...
		side = "civ";
		uniforms[] = {		
			{ "U_C_Poloshirt_blue", "", 15, "" },
			{ "U_C_Poloshirt_burgundy", "", 15, "" },
			{ "U_C_Poloshirt_redwhite", "", 15, "" },
			{ "U_C_Poloshirt_salmon", "", 15, "" },
			{ "U_C_Poloshirt_stripped", "", 15, "" },
			{ "U_C_Poloshirt_tricolour", "", 15, "" },
			{ "U_C_HunterBody_grn", "", 15, "" },
			{ "U_OrestesBody", "", 15, "" },
			{ "U_C_Journalist", "", 15, "" },
			{ "U_C_man_sport_1_F", "", 15, "" },
			{ "U_C_man_sport_2_F", "", 15, "" },
			{ "U_C_man_sport_3_F", "", 15, "" },
			{ "U_C_Man_casual_1_F", "", 15, "" },
			{ "U_C_Man_casual_2_F", "", 15, "" },
			{ "U_C_Man_casual_3_F", "", 15, "" },
			{ "U_C_Man_casual_4_F", "", 15, "" },
			{ "U_C_Man_casual_5_F", "", 15, "" },
			{ "U_C_Man_casual_6_F", "", 15, "" },
		...
		backpacks[] = {
			...
			{ "B_Bergen_sgg", "", 150, "" },
			{ "B_Kitbag_cbr", "", 150, "" },
			{ "B_ViperHarness_ghex_F", "", 250, "" },
			{ "B_ViperHarness_oli_F", "", 250, "" },
			{ "B_ViperHarness_khk_F", "", 250, "" },
			{ "B_ViperHarness_hex_F", "", 250, "" },
			{ "B_Carryall_khk", "", 300, "" },
			{ "B_Carryall_oli", "", 300, "" },
			{ "B_Carryall_ghex_F", "", 300, "" },
			{ "B_Carryall_mcamo", "", 350, "" },
			{ "B_Carryall_oucamo", "", 350, "" },
			{ "B_Bergen_dgtl_F", "", 400, "" },
			{ "B_Bergen_hex_F", "", 400, "" },
			{ "B_Bergen_mcamo_F", "", 400, "" },
			{ "B_Bergen_tna_F", "", 400, "" }		
		};
	};
	...
	class ems_clothing {
		...
		headgear[] = {
			{ "H_Cap_blu", "Standard Medic Cap", 50, "" },
			{ "H_Watchcap_camo", "Senior Beanie", 50, "" },
			{ "H_HelmetB_light_black", "Combat Helmet", 50, "license_med_mCM" },
			{ "H_Watchcap_blk", "Paramedic Beanie", 50, "" },
			{ "H_ShrekMask", "Dr Shrek", 50, "" },
			{ "H_PilotHelmetHeli_B", "Pilot Helmet", 50, "" },
			{ "H_Construction_headset_red_F", "Red Safety Helmet", 50, "" },
			{ "H_ALFR_Gasmask", "Gas Mask", 50, "" }
		};

		goggles[] = {
			{ "G_Diving", "Diving Goggles", 50, "license_med_mSR" },
			{ "G_Shades_Red", "", 200, "" },
			{ "G_Shades_Green", "", 200, "" },
			{ "G_Shades_Blue", "", 200, "" },
			{ "G_Shades_Black", "", 200, "" },
		...
		vests[] = {
			{ "V_RebreatherIR", "Rebreather", 50, "license_med_mSR" },
			{ "V_PlateCarrierSpec_blk", "Combat Vest", 50, "license_med_mCM" }
		};
	...
	class cop_clothing {
		...
		side = "cop";
		uniforms[] = {
			{ "U_Marshal", "Police Uniform", 0, "call CL_coplevel >= 1" },
			{ "U_B_GEN_Soldier_F", "Police Uniform", 0, "call CL_coplevel >= 9" },
			{ "U_B_PilotCoveralls", "Pilot Uniform", 0, "license_cop_cAirA" },
		...
		headgear[] = {
			...
			{ "H_Beret_blk", "Sergeant Beret", 0, "call CL_coplevel >= 5" },
			{ "H_Beret_02", "Lieutenant Beret", 0, "call CL_coplevel >= 7" },
			{ "H_Beret_Colonel", "Command Beret", 0, "call CL_coplevel >= 8" },
			{ "H_Beret_gen_F", "Commisioner Beret", 0, "call CL_coplevel >= 9" },
		...
		goggles[] = {
			...
			{ "G_Tactical_Clear", "Training Glasses", 0, "call CL_coplevel >= 5" },
			{ "G_Tactical_Black", "Training Shades", 0, "call CL_coplevel >= 6" },
		...
		vests[] = {
			...
			{ "V_PlateCarrier1_blk", "Command Plate Vest", 0, "call CL_coplevel >= 5" },
		...
		backpacks[] = {
			{ "B_Kitbag_cbr", "(UC) Kitbag (Biege)", 150, "license_cop_cUC" },
	...
	class reb {
		...
		vests[] = {
			{ "NONE", "Remove Vest", 0, "" },
			{ "V_TacVest_blk", "Enforcers vest", 5000, "" },
			{ "V_BandollierB_cbr", "Slash Bandolier", 1000, "" },
			{ "V_HarnessO_brn", "LBV Harness", 1100, "" },
			{ "V_TacVest_khk", "Tactical Vest Khaki", 1150, "" },
			{ "V_TacVest_gen_F", "Tactical Vest Gendarmerie", 1180, "" }
		};
		...
		backpacks[] = {
			...
			{ "B_AssaultPack_blk", "", 60, "" },
			{ "B_Kitbag_mcamo", "", 150, "" },
			{ "B_TacticalPack_oli", "", 150, "" },
			{ "B_FieldPack_ocamo", "", 150, "" },
			{ "B_AssaultPack_blk", "", 150, "" },
			{ "B_Bergen_sgg", "", 150, "" },
			{ "B_Kitbag_cbr", "", 150, "" },
			{ "B_Carryall_oli", "", 300, "" },
			{ "B_HuntingBackpack", "", 300, "" },
			{ "B_ViperHarness_ghex_F", "Slim Backpack Green Hex", 250, "" },
			{ "B_ViperHarness_oli_F", "Slim Backpack Olive", 250, "" },
			{ "B_ViperHarness_khk_F", "Slim Backpack Khaki", 250, "" },
			{ "B_ViperHarness_hex_F", "Slim Backpack Hex", 250, "" },
			{ "B_Carryall_mcamo", "", 300, "" },
			{ "B_Carryall_oucamo", "",300, "" },
			{ "B_Carryall_ocamo", "", 300, "" },
			{ "B_Carryall_khk", "", 300, "" },
			{ "B_Bergen_dgtl_F", "", 450, "" },
			{ "B_Bergen_hex_F", "", 450, "" },
			{ "B_Bergen_mcamo_F", "", 450, "" },
			{ "B_Bergen_tna_F", "", 450, "" }
		};
	};
	...
	class corp {
		...
		vests[] = {
			{ "V_BandollierB_oli", "Slash Bandolier Olive", 500, "" },
			{ "V_HarnessOGL_ghex_F", "LBV Harness Green Hex", 1000, "" },
			{ "V_TacVest_oli", "Tactical Vest Olive", 2500, "" },
			{ "V_PlateCarrier1_tna_F", "Carrier Lite", 20000, "" },
			{ "V_PlateCarrierIA1_dgtl", "GA Carrier Lite", 20000, "" }
		};
