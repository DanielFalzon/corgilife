...
*/
	...
	class reb {
		...
		license = "reb";
		level[] = { "", "", -1, "" };
		items[] = { "waterBottle", "rabbit", "peach", "redgull", "tbacon", "lockpick", "toolkit", "pickaxe", "chainsaw", "fuelFull", "apple", "boltcutter", "blastingCharge" };
	};
	...
	class corp {
		...
		license = "corp";
		level[] = { "", "", -1, "" };
		items[] = { "waterBottle", "rabbit", "peach", "redgull", "tbacon", "lockpick", "toolkit", "pickaxe", "chainsaw", "fuelFull", "apple", "boltcutter" };
	};
