class CarShops {
	...
	*/
	...
	class ems_car {
		...
		vehicles[] = {			
			{ "C_Van_02_medevac_F", "call CL_mediclevel >= 1" }
		};
	};
	...
	class cop_car {
		...
		vehicles[] = {
			...
			{ "B_MRAP_01_F", "license_cop_cSWAT || call CL_coplevel >= 6" },
...
class CLCfgVehicles {
	...
	*/
	...
	class B_Heli_Transport_01_F {
		...
		textures[] = {
			{ "Police", "Cop", {
				"\CL\textures\UH80\Police\Police_UH80_1.paa",
				"\CL\textures\UH80\Police\Police_UH80_2.paa"
			}, "" },
			{ "Default", "civ", {
	...
	class B_Heli_Light_01_F {
		...
		textures[] = {
			...
			{ "EMS", "med", {
				"\CL\textures\Hummingbird\Medic\Hummingbird_Medic.paa"
			}, "license_med_mAir" },
			{ "Undercover Hummingbird", "cop", {
				"\a3\air_f\Heli_Light_01\Data\Skins\heli_light_01_ext_digital_co.paa"
			}, "license_cop_cUC" },
			{ "Police", "cop", {
				"\CL\textures\Hummingbird\Police\Hummingbird_Police.paa"
			}, "" },
			{ "Tactical", "cop", {
	...
	class O_Heli_Light_02_unarmed_F {
		...
		textures[] = {
			...
			{ "EMS", "med", {
				"\CL\textures\Orca\Medic\Orca_Medic.paa"
			}, "license_med_mAir" }
		};
	};
	...
	class I_Heli_light_03_unarmed_F {
		...
		textures[] = {
			...
			{ "Police", "cop", {
				"\CL\textures\Hellcat\Police\Hellcat_Police.paa"
			}, "" }
		};
	};
	...
	class O_LSV_02_unarmed_F { //--- Ifrit;
		vItemSpace = 70;
		conditions = "";
		price = 80000;
		textures[] = {};
